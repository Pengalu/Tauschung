...
func _draw():
	...
	var points = PackedVector2Array([$point0.position,$point1.position,$point2.position])
	var colors = PackedColorArray([color])
	var indexes = [$point0.z_index,$point1.z_index,$point2.z_index]
	var pointsa = [$point0.position,$point1.position,$point2.position]
